  ...
  return (
      <>
          <div className='bg-[#002228] text-white pt-[96px]  h-[525px] md:h-[433px] lg:h-[443px]'>
              <h3 className='text-center  text-[#0FF1F6]'>
                  GET STARTED
              </h3>

              <h2 className='text-center text-[36px] md:w-[640px] mx-auto mt-[23px]'>
                  Embrace the new era of outbound.
              </h2>
              <p className='text-center mt-[23px]'>Wizia lets you train, activate, and optimize aiDRs.
